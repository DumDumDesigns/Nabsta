 ...
 *
 *   src/com/spazomatic/nabsta/NativeAudio.java
 */
...
void Java_com_spazomatic_nabsta_NativeAudio_createEngine(JNIEnv* env, jclass clazz)
{
    SLresult result;
...
void Java_com_spazomatic_nabsta_NativeAudio_createBufferQueueAudioPlayer(JNIEnv* env,
        jclass clazz)
{
    SLresult result;
...
jboolean Java_com_spazomatic_nabsta_NativeAudio_createUriAudioPlayer(JNIEnv* env, jclass clazz,
        jstring uri)
{
    SLresult result;
...
void Java_com_spazomatic_nabsta_NativeAudio_setPlayingUriAudioPlayer(JNIEnv* env,
...
void Java_com_spazomatic_nabsta_NativeAudio_setLoopingUriAudioPlayer(JNIEnv* env,
...
void Java_com_spazomatic_nabsta_NativeAudio_setChannelMuteUriAudioPlayer(JNIEnv* env,
...
void Java_com_spazomatic_nabsta_NativeAudio_setChannelSoloUriAudioPlayer(JNIEnv* env,
...
int Java_com_spazomatic_nabsta_NativeAudio_getNumChannelsUriAudioPlayer(JNIEnv* env, jclass clazz)
{
    SLuint8 numChannels;
    SLresult result;
    SLMuteSoloItf muteSoloItf = getMuteSolo();
...
void Java_com_spazomatic_nabsta_NativeAudio_setVolumeUriAudioPlayer(JNIEnv* env, jclass clazz,
        jint millibel)
{
    SLresult result;
...
void Java_com_spazomatic_nabsta_NativeAudio_setMuteUriAudioPlayer(JNIEnv* env, jclass clazz,
        jboolean mute)
{
    SLresult result;
    SLVolumeItf volumeItf = getVolume();
...
void Java_com_spazomatic_nabsta_NativeAudio_enableStereoPositionUriAudioPlayer(JNIEnv* env,
...
void Java_com_spazomatic_nabsta_NativeAudio_setStereoPositionUriAudioPlayer(JNIEnv* env,
...
jboolean Java_com_spazomatic_nabsta_NativeAudio_enableReverb(JNIEnv* env, jclass clazz,
        jboolean enabled)
{
    SLresult result;
...
jboolean Java_com_spazomatic_nabsta_NativeAudio_selectClip(JNIEnv* env, jclass clazz, jint which,
        jint count)
{
    switch (which) {
    case 0:     // CLIP_NONE
...
jboolean Java_com_spazomatic_nabsta_NativeAudio_createAssetAudioPlayer(JNIEnv* env, jclass clazz,
...
void Java_com_spazomatic_nabsta_NativeAudio_setPlayingAssetAudioPlayer(JNIEnv* env,
        jclass clazz, jboolean isPlaying)
{
    SLresult result;
...
jboolean Java_com_spazomatic_nabsta_NativeAudio_createAudioRecorder(JNIEnv* env, jclass clazz)
{
    SLresult result;
...
void Java_com_spazomatic_nabsta_NativeAudio_startRecording(JNIEnv* env, jclass clazz)
{
    SLresult result;
...
void Java_com_spazomatic_nabsta_NativeAudio_shutdown(JNIEnv* env, jclass clazz)
{
