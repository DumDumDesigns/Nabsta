    ...
    */
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(',');
            SqlUtils.appendColumns(builder, "T2", daoSession.getSongDao().getAllColumns());
            ...
            builder.append(" LEFT JOIN SONG T2 ON T.'SONG_ID_FK'=T2.'_id'");
            builder.append(' ');
    ...
    protected Track loadCurrentDeep(Cursor cursor, boolean lock) {
        ...
        offset += daoSession.getImageDao().getAllColumns().length;

        Song song = loadCurrentOther(daoSession.getSongDao(), cursor, offset);
        entity.setSong(song);
